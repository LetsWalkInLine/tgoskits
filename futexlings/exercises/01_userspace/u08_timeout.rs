...
impl MiniFutex {
    ...
    fn wait_timeout(&self, expected: u32, timeout: Duration) -> WaitResult {
        // TODO: Return Mismatch immediately when the value differs, TimedOut
        // when the timeout expires, and Woken after a value-changing wake.
        todo!("implement timed MiniFutex wait")
    }
}
