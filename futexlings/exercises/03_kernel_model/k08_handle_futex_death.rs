...
fn handle_futex_death(word: &mut u32, exiting_tid: u32) -> bool {
    // TODO: If the owner TID bits match `exiting_tid`, clear the TID bits, set
    // FUTEX_OWNER_DIED, preserve non-owner bits, and report that a wake is needed.
    todo!("apply robust futex owner-death handling")
}
